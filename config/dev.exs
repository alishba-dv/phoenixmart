...
config :api, Api.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "cUYr0/RtcfaUFoJUPcD5QZl4g5Wvnq7XEsHoyTDKCEXuNCWGxYTDqX4NyOXXPQnx",
  watchers: [
...
config :api, Api.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/api/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]
